...
// Define the correct answers as a record of question keys to correct answers
...
const SecGradeLesson1: React.FC = () => {
  ...
  const questions = [
    {
      key: "q1",
      text: "Do the addition: 12 + 12",
      options: ["2", "34", "11", "24"],
    },
    {
      key: "q2",
      text: "Do the addition: 10 + 23",
      options: ["73", "5", "8", "33"],
    },
    {
      key: "q3",
      text: "Do the addition: 40 + 11",
      options: ["41", "21", "51", "8"],
    },
    {
      key: "q4",
      text: "Do the addition: 11 + 77",
      options: ["58", "28", "78", "88"],
    },
    {
      key: "q5",
      text: "Do the addition: 39 + 45",
      options: ["13", "2", "84", "9"],
    },
    {
      key: "q6",
      text: "Do the addition: 00 + 99",
      options: ["99", "33", "0", "6"],
    },
    {
      key: "q7",
      text: "Do the addition: 10 + 10",
      options: ["20", "70", "50", "30"],
    },
  ];
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        ...
        <Text style={styles.description}>
          In this lesson, we will discuss further on arithmetics. We will learn
          how to do addition in double digits. After you have finished the video
          below, enjoy practicing with the new skills you have achieved today.
          Go Magicians!
        </Text>
      </View>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.video}>
          <YouTubeIframe height={200} videoId="yFAh4VNMFA" />
        </View>
      </View>
          ...
          <View key={question.key} style={styles.problemContainer}>
            ...
            {question.options.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.optionButton,
                  selectedAnswers[question.key as QuestionKey] === option &&
      ...
      <View style={styles.quizSection}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/SecondGrade/SecGradeQuiz1")}
        >
...
export default SecGradeLesson1;
