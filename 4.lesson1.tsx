...
const FourthGradeLesson1: React.FC = () => {
  ...
  const questions = [
    {
      key: "q1",
      text: "(1/2) is equivalent to (2/4)",
      options: ["True", "False"],
    },
    {
      key: "q2",
      text: "(3/6) is greater than (1/2)",
      options: ["True", "False"],
    },
    {
      key: "q3",
      text: "(5/10) is equal to (1/2)",
      options: ["True", "False"],
    },
    {
      key: "q4",
      text: "(4/8) is greater than (2/4)",
      options: ["True", "False"],
    },
    {
      key: "q5",
      text: "(2/5) is less than (4/10)",
      options: ["True", "False"],
    },
    {
      key: "q6",
      text: "(6/9) is equivalent to (2/4)",
      options: ["True", "False"],
    },
    {
      key: "q7",
      text: "(3/4) is smaller than (6/8)",
      options: ["True", "False"],
    },
  ];
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.title}>Lesson 1: Fractions</Text>
        <Text style={styles.description}>
          In this lesson, we will discuss fractions. After you have finished the
          video below, enjoy practicing with the new skills you have achieved
          today. Go Magicians!
        </Text>
      </View>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.video}>
          <YouTubeIframe height={200} videoId="ke5Ik-Iq0YQ" />
        </View>
      </View>
      ...
      <View style={styles.quizSection}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/FourthGrade/FourthGradeQuiz1")}
        >
...
export default FourthGradeLesson1;
