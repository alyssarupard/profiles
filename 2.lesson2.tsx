...
const SecGradeLesson2: React.FC = () => {
  ...
  const questions = [
    {
      key: "q1",
      text: "Do the subtraction: 35 - 15",
      options: ["20", "30", "11", "24"],
    },
    {
      key: "q2",
      text: "Do the subtraction: 57 - 23",
      options: ["73", "5", "8", "34"],
    },
    {
      key: "q3",
      text: "Do the subtraction: 53 - 12",
      options: ["41", "21", "51", "8"],
    },
    {
      key: "q4",
      text: "Do the subtraction: 80 - 70",
      options: ["58", "20", "10", "88"],
    },
    {
      key: "q5",
      text: "Do the subtraction: 60 - 30",
      options: ["30", "2", "84", "9"],
    },
    {
      key: "q6",
      text: "Do the subtraction: 22 - 11",
      options: ["99", "33", "11", "6"],
    },
    {
      key: "q7",
      text: "Do the subtraction: 10 - 00",
      options: ["20", "00", "10", "30"],
    },
  ];
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        ...
        <Text style={styles.description}>
          In this lesson, we will discuss subtraction with double digits. After
          you have finished the video below, enjoy practicing with the new
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.video}>
          <YouTubeIframe height={200} videoId="Buyaqe_L5-Y" />
        </View>
      </View>
      ...
      <View style={styles.quizSection}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/SecondGrade/SecGradeQuiz2")}
        >
...
export default SecGradeLesson2;
