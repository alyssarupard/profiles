...
const FifthGradeLesson1: React.FC = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.title}>Lesson 1: Decimals</Text>
        <Text style={styles.description}>
          In this lesson, we will discuss decimals. After you have finished the
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.video}>
          <YouTubeIframe height={200} videoId="UCBXoLb2ItI" />
        </View>
      </View>
      ...
      <View style={styles.quizSection}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/FifthGrade/FifthGradeQuiz1")}
        >
...
export default FifthGradeLesson1;
